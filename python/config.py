...
effectOptions = {
    ...
    "Energy": {
        ...
        "scale": 1.0,  # Width of effect on strip
    ...
    "FreqEnergy": {
        "blur": 1.0,  # Amount of blur to apply
        "scale": 1.2,  # Width of effect on strip
        "r_multiplier": 1.0,  # How much red
        "mirror": True,  # Reflect output down centre of strip
        "g_multiplier": 1.0,  # How much green
        "b_multiplier": 1.0,
    ...
    "Wave": {
        "color_wave": "Red",  # Colour of moving bit
    ...
    "Fade": {
        "color_mode": "Spectral",  # Colour gradient to fade through
